...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/17 17:09:05 by njeanbou          #+#    #+#             */
/*   Updated: 2024/04/18 16:55:05 by njeanbou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main (void)
{
	char *input = "cat -l fichier1.txt fichier2.txt|grep \"\'mot cles\'\">>resultats.txt";
	int	i = 0;
	int len = count_word(input);
	char **tab = split_para(input);
	printf("%s\n", input);
	printf("%d\n\n", len);
	while (tab[i] != NULL)
		printf("%s\n", tab[i++]);
